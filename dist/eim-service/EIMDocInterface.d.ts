...
declare type showHide = 'show' | 'hide';
...
export interface IFormSectionBadge {
    name: string;
    type: 'circleIndigo' | 'circleGray' | 'circleTeal' | 'circleTealO' | 'circleCyanO' | 'circleOrange' | 'circleRed' | 'circleRedO' | 'squareIndigo' | 'squareGray' | 'squareTeal' | 'squareOrange' | 'squareRed';
    label?: string;
    icon?: string;
