import { ISetAppListAction, LOAD_APP_LIST, SET_APP_LIST } from '../../../src/account-manager/actions/EimAppListActions';
import appListReducer from '../../../src/account-manager/reducers/EimAppListReducer';
