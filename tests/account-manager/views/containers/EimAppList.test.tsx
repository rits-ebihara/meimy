...
import { IEimApp } from '../../../../dist/account-manager/states/IEimAppListState';
import {
    createLoadAppListAction,
    createSetAppListAction,
} from '../../../../src/account-manager/actions/EimAppListActions';
import NavigateActions from '../../../../src/account-manager/actions/NavigateActions';
import IEimAppList from '../../../../src/account-manager/states/IEimAppListState';
import { __private__ } from '../../../../src/account-manager/views/containers/EimAppList';
...
jest.mock('../../../../src/account-manager/actions/EimAppListActions', () => {
    return {
