...
import { DrawerContent, ILocalState, IProps } from '../../src/components/DrawerView';
...
describe('render', () => {
    let props: IProps;
    let wrapper: ShallowWrapper<IProps, ILocalState, DrawerContent>;
    beforeEach(() => {
